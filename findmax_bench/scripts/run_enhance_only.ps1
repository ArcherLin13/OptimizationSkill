...
Write-Host "============================================================"
Write-Host " RUN: ocl_test_enhance_only  - enhanceBrightness ONLY"
Write-Host " Compare: 2d_1px | 2d_v4 (vload4) | 1d_stride"
Write-Host "============================================================"
...
$cmd = "cd $RemoteDir && chmod +x ocl_test_enhance_only && ./ocl_test_enhance_only --2d enhance_brightness.cl --2dv4 enhance_brightness_2d_v4.cl --1d enhance_brightness_opt.cl --width $Width --height $Height --runs $Runs --lwsx $LwsX --lwsy $LwsY --lws-opt $LwsOpt --nwg $Nwg --max $Max"
Write-Host $cmd
& $Hdc shell $cmd
